...
func (re *Regexp) ReplaceAllString(src, repl string) string {
	...
	b := re.replaceAll(nil, src, ColumnRanges{}, n, func(dst []byte, match []int) []byte {
...
func (re *Regexp) ReplaceAllLiteralString(src, repl string) string {
	return string(re.replaceAll(nil, src, ColumnRanges{}, 2, func(dst []byte, match []int) []byte {
...
func (re *Regexp) ReplaceAllStringFunc(src string, repl func(string) string) string {
	b := re.replaceAll(nil, src, ColumnRanges{}, 2, func(dst []byte, match []int) []byte {
		return append(dst, repl(src[match[0]:match[1]])...)
	})
	return string(b)
}

func (re *Regexp) replaceAll(bsrc []byte, src string, ranges ColumnRanges, nmatch int, repl func(dst []byte, m []int) []byte) []byte {
...
func (re *Regexp) ReplaceAll(src, repl []byte) []byte {
	...
	srepl := ""
	b := re.replaceAll(src, "", ColumnRanges{}, n, func(dst []byte, match []int) []byte {
...
func (re *Regexp) ReplaceAllLiteral(src, repl []byte) []byte {
	return re.replaceAll(src, "", ColumnRanges{}, 2, func(dst []byte, match []int) []byte {
		return append(dst, repl...)
	})
}
...
func (re *Regexp) allMatches(s string, b []byte, ranges ColumnRanges, n int, deliver func([]int)) {
	var end int
	if b == nil {
		end = len(s)
	} else {
...
func (re *Regexp) Find(b []byte) []byte {
	var dstCap [2]int
	a := re.doExecute(nil, b, "", ColumnRanges{}, 0, 2, dstCap[:0])
	if a == nil {
		return nil
	}
...
func (re *Regexp) FindIndex(b []byte) (loc []int) {
	a := re.doExecute(nil, b, "", ColumnRanges{}, 0, 2, nil)
	if a == nil {
		return nil
	}
	return a[0:2]
...
func (re *Regexp) FindString(s string) string {
	var dstCap [2]int
	a := re.doExecute(nil, nil, s, ColumnRanges{}, 0, 2, dstCap[:0])
	if a == nil {
		return ""
	}
	return s[a[0]:a[1]]
...
func (re *Regexp) FindStringIndex(s string) (loc []int) {
	a := re.doExecute(nil, nil, s, ColumnRanges{}, 0, 2, nil)
	if a == nil {
		return nil
	}
	return a[0:2]
...
func (re *Regexp) FindReaderIndex(r io.RuneReader) (loc []int) {
	a := re.doExecute(r, nil, "", ColumnRanges{}, 0, 2, nil)
	if a == nil {
		return nil
	}
	return a[0:2]
...
func (re *Regexp) FindSubmatch(b []byte) [][]byte {
	var dstCap [4]int
	a := re.doExecute(nil, b, "", ColumnRanges{}, 0, re.prog.NumCap, dstCap[:0])
	if a == nil {
		return nil
	}
...
func (re *Regexp) FindSubmatchIndex(b []byte) []int {
	return re.pad(re.doExecute(nil, b, "", ColumnRanges{}, 0, re.prog.NumCap, nil))
}
...
func (re *Regexp) FindStringSubmatch(s string) []string {
	var dstCap [4]int
	a := re.doExecute(nil, nil, s, ColumnRanges{}, 0, re.prog.NumCap, dstCap[:0])
	if a == nil {
		return nil
	}
...
func (re *Regexp) FindStringSubmatchIndex(s string) []int {
	return re.pad(re.doExecute(nil, nil, s, ColumnRanges{}, 0, re.prog.NumCap, nil))
}
...
func (re *Regexp) FindReaderSubmatchIndex(r io.RuneReader) []int {
	return re.pad(re.doExecute(r, nil, "", ColumnRanges{}, 0, re.prog.NumCap, nil))
}
...
func (re *Regexp) FindAll(b []byte, n int) [][]byte {
	...
	var result [][]byte
	re.allMatches("", b, ColumnRanges{}, n, func(match []int) {
		if result == nil {
...
func (re *Regexp) FindAllIndexRanges(b []byte, n int, ranges ColumnRanges) [][]int {
	if n < 0 {
		n = len(b) + 1
	}
	var result [][]int
...
func (re *Regexp) FindAllString(s string, n int) []string {
	...
	var result []string
	re.allMatches(s, nil, ColumnRanges{}, n, func(match []int) {
		if result == nil {
